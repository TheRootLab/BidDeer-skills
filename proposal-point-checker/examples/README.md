...
- `demos/picture-review-enhanced/`: Enhanced synthetic demo using business license and project training/certificate images, including numeric threshold and date-age checks.
