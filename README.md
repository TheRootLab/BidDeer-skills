...
`skills/proposal-point-checker/templates/io-contract.md`
...
`skills/proposal-point-checker/examples/`

示例输入：

`skills/proposal-point-checker/examples/sample_checklist.md`

`skills/proposal-point-checker/examples/sample_proposal_excerpt.txt`

示例输出：

`skills/proposal-point-checker/examples/sample_output.md`
...
所有高风险识别结果都必须由具备相应经验教学的专业人员进行复核和确认。
